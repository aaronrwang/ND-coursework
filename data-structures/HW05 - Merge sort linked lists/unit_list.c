...
bool test_00_node_create() {
    ...
    unit_assert(n1->val == 101);
    unit_assert(n1->next->val == 100);
    unit_assert(n1->next->next == NULL);
    node_delete(n0);
    node_delete(n1);
    return EXIT_SUCCESS;
}
...
bool test_02_list_append_head() {
    ...
    unit_assert(head->val == 102);
    unit_assert(head->next->val == 101);
    unit_assert(head->next->next->val == 100);
    list_delete(head);
    return EXIT_SUCCESS;
}
...
bool test_03_list_append_tail() {
    ...
    unit_assert(head->val == 100);
    unit_assert(head->next->val == 101);
    unit_assert(head->next->next->val == 102);
    list_delete(head);
    return EXIT_SUCCESS;
}
...
bool test_04_list_split() {
    ...
    unit_assert(left->val == 1);
    unit_assert(left->next->val == 2);
    unit_assert(left->next->next->val == 3);
    unit_assert(left->next->next->next == NULL);
    unit_assert(right->val == 4);
    unit_assert(right->next->val == 5);
    unit_assert(right->next->next->val == 6);
    unit_assert(right->next->next->next == NULL);
    list_delete(left);
    list_delete(right);
    ...
    list_split(head, &left, &right);
    unit_assert(left->val == 1);
    unit_assert(left->next == NULL);
    unit_assert(right->val == 2);
    unit_assert(right->next->val == 3);
    unit_assert(right->next->next == NULL);
    list_delete(left);
    list_delete(right);
    return EXIT_SUCCESS;
}
...
bool test_05_list_merge() {
    ...
    unit_assert(head->val == 1);
    unit_assert(head->next->val == 2);
    list_delete(head);
